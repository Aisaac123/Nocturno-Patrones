...
export function crearDatos(repositorio: Repositorio) {
    ...
    temporada1.agregarEpisodio(new Episodio(2, 'Cat\'s in the Bag...', 48, 'https://www.youtube.com/watch?v=t4H8DSFm2i0'));
    temporada1.agregarEpisodio(new Episodio(3, '...And the Bag\'s in the River', 46, 'https://www.youtube.com/watch?v=DCidKqcY2n4'));

    const temporada2 = serie.agregarTemporada(2);
    temporada2.agregarEpisodio(new Episodio(1, 'Seven Thirty-Seven', 48, 'https://www.youtube.com/watch?v=RTpR5XU8s6s'));
    temporada2.agregarEpisodio(new Episodio(2, 'Grilled', 43, 'https://www.youtube.com/watch?v=tE9-UwchYo4'));
